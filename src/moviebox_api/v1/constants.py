...
MIRROR_HOSTS = (
    "h5.aoneroom.com",
    # See - https://github.com/Simatwa/moviebox-api/issues/63
    # "movieboxapp.in",
    # "moviebox.pk",
    # "moviebox.ph",
    # "moviebox.id",
...
class SubjectType(IntEnum):
    ...
    @classmethod
    def get_all_subject_types(cls) -> set["SubjectType"]:
        return {entry for entry in cls if entry is not cls.ALL}

    @classmethod
    def get_series_like_subject_types(cls) -> set["SubjectType"]:
        return {cls.TV_SERIES, cls.ShortTV}

    @classmethod
    def get_movies_like_subject_types(cls) -> set["SubjectType"]:
        return cls.get_all_subject_types() - cls.get_series_like_subject_types()

    @classmethod
    def is_series_like(cls, subject_type: "SubjectType") -> bool:
        return subject_type in cls.get_series_like_subject_types()

    @classmethod
    def is_movie_like(cls, subject_type: "SubjectType") -> bool:
        return cls.is_series_like(subject_type) is False
